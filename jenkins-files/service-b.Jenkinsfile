                ...
                container('docker') {
                    withCredentials([usernamePassword(credentialsId: 'AWS', usernameVariable: 'AWS_ACCESS_KEY_ID', passwordVariable: 'AWS_SECRET_ACCESS_KEY')]) {
                        sh """
                            ...
                            FINANCE_SERVICE=\$(jq -r '.FINANCE_SERVICE' env-files/\$ENV_FILE.json)
                            PAYMENT_SERVICE=\$(jq -r '.PAYMENT_SERVICE' env-files/\$ENV_FILE.json)
